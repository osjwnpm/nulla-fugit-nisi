# @osjwnpm/nulla-fugit-nisi

> forked from [@osjwnpm/nulla-fugit-nisiode](https://www.npmjs.com/package/@osjwnpm/nulla-fugit-nisiode) v11.1.0. as the original repository seems [no longer maintained](https://github.com/mysticatea/@osjwnpm/nulla-fugit-nisiode/issues/300).

[![npm version](https://img.shields.io/npm/v/@osjwnpm/nulla-fugit-nisi.svg)](https://www.npmjs.com/package/@osjwnpm/nulla-fugit-nisi)
[![Downloads](https://img.shields.io/npm/dm/@osjwnpm/nulla-fugit-nisi.svg)](https://www.npmjs.com/package/@osjwnpm/nulla-fugit-nisi)
[![Build Status](https://github.com/osjwnpm/nulla-fugit-nisi/workflows/CI/badge.svg)](https://github.com/osjwnpm/nulla-fugit-nisi/actions)
...
```sh
npm install --save-dev eslint @osjwnpm/nulla-fugit-nisi
```
...
```js
const nodePlugin = require("@osjwnpm/nulla-fugit-nisi")
...
💼 [Configurations](https://github.com/osjwnpm/nulla-fugit-nisi#-configs) enabled in.\
☑️ Set in the `flat/recommended` [configuration](https://github.com/osjwnpm/nulla-fugit-nisi#-configs).\
🟢 Set in the `flat/recommended-module` [configuration](https://github.com/osjwnpm/nulla-fugit-nisi#-configs).\
✅ Set in the `flat/recommended-script` [configuration](https://github.com/osjwnpm/nulla-fugit-nisi#-configs).\
☑️ Set in the `recommended` [configuration](https://github.com/osjwnpm/nulla-fugit-nisi#-configs).\
🟢 Set in the `recommended-module` [configuration](https://github.com/osjwnpm/nulla-fugit-nisi#-configs).\
✅ Set in the `recommended-script` [configuration](https://github.com/osjwnpm/nulla-fugit-nisi#-configs).\
...
`@osjwnpm/nulla-fugit-nisi` follows [semantic versioning](http://semver.org/) and [ESLint's Semantic Versioning Policy](https://github.com/eslint/eslint#semantic-versioning-policy).
...
- [GitHub Releases](https://github.com/osjwnpm/nulla-fugit-nisi/releases)
